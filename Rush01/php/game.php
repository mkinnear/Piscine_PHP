...
$data3 = $db->prepare('SELECT player1, player2, rounds FROM games_in_progress WHERE id_game=?;');
...
$update = $db->prepare("UPDATE `games_in_progress` SET `player1`=?,`player2`=?,`rounds`=? WHERE `id_game`=?");
